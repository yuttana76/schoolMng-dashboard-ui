  ...
  return (
    <div className='flex-1 p-4 flex flex-col gap-4 xl:flex-row'>
        ...
        <div className='w-full xl:w-2/3'>
            ...
            <div className='flex flex-col lg:flex-row gap-4'>
                ...
                <div className='bg-lamaSky py-6 px-4 rounded-md flex-1 flex gap-4'>
                    ...
                    <div className='w-2/3 flex flex-col justify-between gap-4'>
                        <h1 className='text-xl font-semibold'>xxxx yyyy</h1>
                        <p className='text-sm text-gray-500'>fsdlf;jsdkfjlsdjfls;ajfksdf</p>
            ...
            {/* BOTTOM */}
            <div className='mt-4 bg-whit rounded-md p-4 h-[800px]'>
        ...
        <div className='w-full xl:w-1/3 flex flex-col gap-4'>
            ...
            <div className='bg-white p-4 rounded-md'>
                ...
                <div className='mt-4 flex gap-4 flex-wrap text-xs text-gray-500'>
                    ...
                    <Link className='p-3 rounded-md bg-lamaYellowLight' href="/" >Student's Exam</Link>
                    <Link className='p-3 rounded-md bg-lamaSkyLight' href="/" >Student's Assignments</Link>
                    <Link className='p-3 rounded-md bg-pink-50' href="/" >Student's Result</Link>
                </div>
            </div>
