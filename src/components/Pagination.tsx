...
const Pagination = () => {
  return (
    <div className="p-4 flex items-center justify-between text-gray-500">
        ...
        <div className="flex items-center ga-2 text-sm ">
            <button className=" px-2 roundec-sm bg-lamaSky ">1</button>
            <button className="px-2 roundec-sm ">2</button>
            <button className="px-2 roundec-sm ">3</button>
            ...
            <button className="px-2 roundec-sm ">10</button>
